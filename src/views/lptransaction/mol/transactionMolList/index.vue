    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionMol:download'])"
          class="filter-item"
          size="mini"
          type="warning"
...
<script>
import { transaction } from '@/api/lptransaction/transactionMolList'
...
export default {
  ...
  methods: {
    ...
    exportExels() {
      ...
      download('/api/transactionMol/download', params).then(result => {
