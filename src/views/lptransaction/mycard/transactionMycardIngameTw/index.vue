    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionMycardIngameTw:download'])"
          class="filter-item"
          size="mini"
          type="warning"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <div v-if="scope.row.delsign === 0">{{ "否" }}</div>
            <div v-if="scope.row.delsign === 1">{{ "是" }}</div>
          </template>
        </el-table-column>
        <el-table-column
          align="center"
...
<script>
import { transaction } from '@/api/lptransaction/mycard/transactionMycardIngameTw'
...
export default {
  ...
  methods: {
    ...
    clearQueryData(toQuery = true) {
      ...
      this.query.stime = this.defaultGetTime
    ...
    exportExels() {
      ...
      download('/api/transactionMycardIngameTw/download', params).then(result => {
