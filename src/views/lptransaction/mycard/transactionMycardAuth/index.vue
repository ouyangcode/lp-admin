    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionMycardAuth:download'])"
          class="filter-item"
          size="mini"
          type="warning"
...
<script>
import { transaction } from '@/api/lptransaction/mycard/transactionMycardAuth'
...
export default {
  ...
  methods: {
    ...
    exportExels() {
      ...
      download('/api/transactionMycardAuth/download', params).then(result => {
