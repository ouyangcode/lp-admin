    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionMycardDj:download'])"
          class="filter-item"
          size="mini"
          type="warning"
...
<script>
import { transaction } from '@/api/lptransaction/mycard/transactionMycardDj'
...
export default {
  ...
  methods: {
    ...
    exportExels() {
      ...
      download('/api/transactionMycardDj/download', params).then(result => {
