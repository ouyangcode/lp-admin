    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionMycardDjnew:download'])"
          class="filter-item"
          size="mini"
          type="warning"
...
<script>
import { transaction } from '@/api/lptransaction/mycard/transactionMycardDjnew'
...
export default {
  ...
  cruds() {
    return CRUD({
      title: 'Mycard fb 储值流水',
      url: '/api/transactionMycardDjnew',
      sort: 'id,desc',
  ...
  methods: {
    ...
    exportExels() {
      ...
      download('/api/transactionMycardDjnew/download', params).then(result => {
