  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        />
        <el-input
          v-model="query.mycardtradeno"
          clearable
          placeholder="mycard订单号"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="crud.toQuery"
        />
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionMycardBillingTw:download'])"
          class="filter-item"
          size="mini"
          type="warning"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <div v-if="scope.row.gamecode">
              {{ scope.row.gamecode+"("+scope.row.servercode+")" }}
            </div>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="scope">
            <div v-if="scope.row.disable === 0">{{ "否" }}</div>
            <div v-if="scope.row.disable === 1">{{ "是" }}</div>
          </template>
        </el-table-column>
        <el-table-column
          align="center"
...
<script>
import { transaction } from '@/api/lptransaction/mycard/transactionMycardBillingTw'
...
export default {
  ...
  methods: {
    ...
    clearQueryData(toQuery = true) {
      ...
      this.query.sdate = this.defaultGetTime
    ...
    exportExels() {
      ...
      download('/api/transactionMycardBillingTw/download', params).then(result => {
