    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionHuawei:download'])"
          class="filter-item"
          size="mini"
          type="warning"
...
<script>
import { transaction } from '@/api/lptransaction/transactionHuawei'
...
export default {
  ...
  methods: {
    ...
    exportExels() {
      ...
      download('/api/transactionHuawei/download', params).then(result => {
