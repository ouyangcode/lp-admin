  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        />
        <el-input
          v-model="query.onestoreId"
          clearable
          placeholder="onestore订单号"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="crud.toQuery"
        />
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionOnestore:download'])"
          class="filter-item"
          size="mini"
          type="warning"
...
<script>
import { transaction } from '@/api/lptransaction/transactionOnestore'
...
export default {
  ...
  methods: {
    ...
    clearQueryData(toQuery = true) {
      ...
      this.query.createtime = this.defaultGetTime
    ...
    exportExels() {
      ...
      download('/api/transactionOnestore/download', params).then(result => {
