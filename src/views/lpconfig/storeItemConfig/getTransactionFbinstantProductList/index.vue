    ...
    <div class="head-container">
      ...
      <div v-if="crud.props.searchToggle">
        ...
        <el-button
          ...
          :disabled="!checkPer(['admin','transactionFbinstantProduct:add'])"
      ...
      <el-table ref="table" v-loading="crud.loading" border :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column align="center" prop="sitecode" label="sitecode" width="120px" />
        <el-table-column align="center" prop="packagename" label="packagename(FBAPPID)" width="170px" />
        <el-table-column align="center" prop="productid" label="productid" width="150px" />
        <el-table-column align="center" prop="money" label="money台币" width="110px" />
        <el-table-column align="center" prop="rgmoney" label="rgmoney美金" width="120px" />
        <el-table-column align="center" prop="lpoint" label="点数" width="110px" />
        ...
        <el-table-column align="center" prop="itemtype" label="类型" width="120px">
          <template slot-scope="scope">
            <div v-if="scope.row.itemtype === 1">{{ "储值游戏币" }}</div>
            <div v-if="scope.row.itemtype === 2">{{ "VIP卡,月卡" }}</div>
          </template>
        </el-table-column>
        <el-table-column align="center" prop="itemtypename" label="类型名" width="120px" />
              ...
              <div class="dise">
                <div class="edit">
                  <el-button
                    size="mini"
                    type="primary"
                    :disabled="!checkPer(['admin','transactionFbinstantProduct:edit'])"
                    icon="el-icon-edit"
...
<script>
import { crudTransactionFbinstantProduct, add, edit } from '@/api/lpconfig/storeItemConfig/transactionFbinstantProduct'
...
const defaultForm = { id: null, gamecode: null, servercode: null, sitecode: null, packagename: null, productid: null, money: null, lpoint: null, currency: null, status: null, rgmoney: null, itemtype: null, itemtypename: null, gold: null }
export default {
  name: 'TransactionFbinstantProduct',
  components: { pagination, crudOperation, rrOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'transactionFbinstantProduct', url: '/api/lpTransactionFbinstantProduct/getTransactionFbinstantProductList', idField: 'id', sort: 'id,desc', crudMethod: { ...crudTransactionFbinstantProduct }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'transactionFbinstantProduct:add'],
        edit: ['admin', 'transactionFbinstantProduct:edit'],
        del: ['admin', 'transactionFbinstantProduct:del']
      },
      rules: {
      },
      isShowDelg: false,
      isShow: false,
      scopeData: { id: null, gamecode: null, servercode: null, sitecode: null, packagename: null, productid: null, money: null, lpoint: null, currency: null, status: null, rgmoney: null, itemtype: null, itemtypename: null, gold: null },
      curdHook: '',
      dlogTitle: '',
      gameCodeList: []
    }
