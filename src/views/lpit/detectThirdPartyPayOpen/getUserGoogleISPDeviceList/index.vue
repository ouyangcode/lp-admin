  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      >
        ...
        <el-table-column align="center" prop="gameCode" label="keychainID">
          <template slot-scope="scope">
            <div
              v-for="(item,index) of Object.keys(scope.row)"
              :key="index"
              class="open"
            >
              {{ query.gameCode }}
        ...
        <el-table-column prop="objKey" align="center" :label="crud.getQueryTitle">
          <template slot-scope="scope">
            <div
              v-for="(item,index) of Object.keys(scope.row)"
              :key="index"
...
<script>
import {
  lpGetUserGoogleISPDeviceList,
  toSetAllowCurrencyPayIOS
} from '@/api/lpitmgr/detectThirdPartyPayOpen/getUserGoogleISPDeviceList'
...
export default {
  name: 'GetUserGoogleISPDeviceList',
  components: { rrOperation, crudOperation, pagination },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({
      title: 'soho測試生成',
      url: '/api/detectThirdPartyPayOpen/getUserGoogleISPDeviceList',
      crudMethod: { ...lpGetUserGoogleISPDeviceList }
    })
  },
  data() {
    return {
  ...
  methods: {
    ...
    getQueryTitle() {
      if (this.query.gameCode && this.query.packageName) {
        this.getQueryTitle = 'ip,passport'
      } else if (this.query.gameCode && this.query.packageName && this.query.passport) {
        this.getQueryTitle = 'ip,gameCode,packageName'
      }
    },
    toBlickList(data) {
      console.log(data)
